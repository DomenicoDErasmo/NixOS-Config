{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/domenico/NixOS-Config/modules/dev_templates/rust_shell";
  project_input_ref = "path:/home/domenico/NixOS-Config/modules/dev_templates/rust_shell";
  devenv_dotfile = "/home/domenico/NixOS-Config/modules/dev_templates/rust_shell/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1001/";
  devenv_runtime = "/run/user/1001/devenv-7d00be1";
  ...
  hostname = "nixos";
  username = "domenico";
  git_root = "/home/domenico/NixOS-Config";
  secretspec = null;
};
    in
    {
